namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAddPerformancesUsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrAddPerformancesUsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrAddPerformancesUsrRealty1MethodsWrapper(Process process)
			: base(process) {
